...
/**
 * Phrase for a warning type, or undefined if it is not a replay drop type.
 * Uses an own-property check so a forged type like `constructor` or `toString`
 * can't reach an inherited Object.prototype member.
 */
