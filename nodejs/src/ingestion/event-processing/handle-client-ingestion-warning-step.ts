...
//
// A Map (not an object literal) so a forged type can't reach Object.prototype
// members - `constructor` would otherwise resolve to a function and bypass the
// allowlist, and `__proto__` would throw.
