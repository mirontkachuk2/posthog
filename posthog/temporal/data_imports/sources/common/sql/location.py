...
def resolve_source_location(
    ...
    *,
    ...
    `config_namespace` → `default`. `response_name` (the Delta subdir) uses `s3_folder_path` when
    ...
    storage_key = inputs.s3_folder_path if isinstance(inputs.s3_folder_path, str) and inputs.s3_folder_path else None
